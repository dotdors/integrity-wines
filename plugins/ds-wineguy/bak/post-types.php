...
/**
 * Disable block editor for Producers and Wines
 *
 * We keep show_in_rest: true (needed for REST API access and future use),
 * but force the classic editor UI. Our meta boxes save via traditional
 * POST/redirect - Gutenberg's in-place REST save doesn't pass $_POST meta
 * box data reliably, causing logo/files/etc to appear saved but not persist.
 */
add_filter('use_block_editor_for_post_type', function($use_block_editor, $post_type) {
    if (in_array($post_type, ['dswg_producer', 'dswg_wine'])) {
        return false;
    }
